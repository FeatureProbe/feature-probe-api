...
public class GuestService {
    ...
    private static final String[] toggleSql= {"INSERT INTO `toggle` (`organize_id`, `name`, `key`, `description`, " +
            "`return_type`, `disabled_serve`, `variations`, `project_key`, `archived`, `client_availability`, " +
            "`deleted`, `modified_by`, `created_by`, `created_time`, `modified_time`) VALUES (${organize_id}, " +
            "'feature toggle01', 'feature_toggle01', '', 'boolean', 0, '[{\\\"value\\\":\\\"false\\\"," +
        ...
        "INSERT INTO `targeting_version` (`organize_id`, `project_key`, `environment_key`, `toggle_key`, " +
                ...
                "`created_time`, `modified_by`) VALUES (${organize_id}, '${project_key}', 'online', " +
        ...
        "INSERT INTO `toggle` (`organize_id`, `name`, `key`, `description`, `return_type`, `disabled_serve`, " +
                "`variations`, `project_key`, `archived`, `client_availability`, `deleted`, `modified_by`, " +
                "`created_by`, `created_time`, `modified_time`) VALUES (${organize_id}, 'feature toggle02', " +
        ...
        "INSERT INTO `toggle` (`organize_id`, `name`, `key`, `description`, `return_type`, `disabled_serve`, " +
                "`variations`, `project_key`, `archived`, `client_availability`, `deleted`, `modified_by`, " +
                "`created_by`, `created_time`, `modified_time`) VALUES (${organize_id}, 'feature toggle03', " +
        ...
        "INSERT INTO `targeting` (`organize_id`, `toggle_key`, `environment_key`, `project_key`, `version`, " +
                ...
                "description\\\":\\\"运营活动对用户可见\\\"}]}', 0,  ${user_id}, ${user_id}, now(), now())",
        ...
        "INSERT INTO `toggle` (`organize_id`, `name`, `key`, `description`, `return_type`, `disabled_serve`, " +
                "`variations`, `project_key`, `archived`, `client_availability`, `deleted`, `modified_by`, " +
                "`created_by`, `created_time`, `modified_time`) VALUES (${organize_id}, 'feature toggle04', " +
    ...
    public Member initGuest(String account) {
        ...
        List<Organize> organizes = new ArrayList<>(1);
        organizes.add(new Organize(account));
        createdMember.setOrganizes(organizes);
        ...
        SecurityContextHolder.setContext(new SecurityContextImpl(new JwtAuthenticationToken(Jwt.withTokenValue("_")
                ...
                .header("iss", "")
                .build())));
        Organize organize = savedMember.getOrganizes().get(0);
        initProjectEnvironment(String.valueOf(organize.getId()), GUEST_INIT_PROJECT_KEY);
        initToggles(organize.getId(), savedMember.getId(), account);
        return savedMember;
    }
    ...
    private void initToggles(Long tenantId, Long userId, String account) {
        for(String str : toggleSql) {
            String sql = str.replace("${organize_id}", String.valueOf(tenantId))
