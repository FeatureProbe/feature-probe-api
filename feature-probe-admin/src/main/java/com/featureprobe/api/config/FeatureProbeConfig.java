...
public class FeatureProbeConfig {
    ...
    private static final String FEATURE_PROBE_API_EVENT_PATH = "/com/featureprobe/api/server/events";
    private static final String FEATURE_PROBE_API_SYNCHRONIZER_PATH = "/com/featureprobe/api/server/toggles";
